...
Besides, Elixhauser hypothesized that the decreased risk of hospital death associated with some comorbidity groups reﬂects a bias in coding in which the severity of overall patient illness inversely affects the likelihood that nonthreatening conditions are coded. 
