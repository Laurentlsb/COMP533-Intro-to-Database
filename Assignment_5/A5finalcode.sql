...
/* 2.Triggers */
/* 2.1 */
delete from truckevent where eventid = 63;
drop trigger if exists printMaintAlert on truckEvent;
drop function if exists maintAlert();
...
delete from truckevent where eventid in (64, 65, 66);
drop trigger if exists insertoverlap on truckEvent;
drop function if exists whetheroverlap();
